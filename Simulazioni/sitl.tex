...
in questo capitolo vengono presentate in dettaglio le simulazioni effettuate in SIL e MIL. Inoltre è presente una sezione in cui verrà riportata parzialmente la soluzione per le simulazioni in PIL. Nella sezione di MILS verrà descritto il modello dei sensonsori e dello stimatore usato nella precedente tesi, \cite{DesTestCarm} per il confronto. Diverse osservazioni e confronti verrano fatti tra le diverse simulazioni. La parte finale descriverà la conclusione del lavoro e eventuali sviluppi futuri.

\section{Simulazione SIL}

\todo[inline]{Qui vengono presentate le simulazioni fatte in software in the loop}
\todo[inline]{Come si lancia una simulazione con foto}
